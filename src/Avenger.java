...
/**
 * Represents an Avenger with properties like alias, name, frequency, and mention order.
 * This class implements Comparable for sorting Avengers based on their aliases.
 */
...
/**
	...
	@Override
	 /**
     * Compares the current Avenger object to another Avenger object based on their aliases.
     *
     * @param other The other Avenger object to compare.
     * @return A negative integer, zero, or a positive integer if this Avenger's alias is less than, equal to,
     *         or greater than the other Avenger's alias.
     */
  ...
  /**
     ...
     * @return True if the other object is an Avenger and has the same alias and name, false otherwise.
     */
 ...
 /**
     * Returns a string representation of the Avenger object, including alias, name, and frequency.
     *
