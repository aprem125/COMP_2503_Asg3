...
public class AvengerComparatorMentionOrder implements Comparator<Avenger> {
	 ...
	 * @return A negative integer, zero, or a positive integer if the mention order
	 *         of the first Avenger is less than, equal to, or greater than the
	 *         mention order of the second Avenger.
	 */
